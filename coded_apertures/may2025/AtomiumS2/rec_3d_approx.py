...
args.eps = 1e-12
args.rho = [1, 20, 10]
args.path_out = f"/data/vnikitin/ESRF/ID16A/20240924_recMay//AtomiumS2/AtomiumS2_codedht_random_007nm/rapprox_{args.n}_{args.lam}_{args.rho[1]}_{args.rho[2]}"
args.show = show
