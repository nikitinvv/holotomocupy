...
n = int(sys.argv[1])#0.3  # object size in each dimension
pad = n//4*0
npos= 18*18
pos_step = 1
z1c = -17.75e-3
...
ne = (4096+2048+1024+256)//(2048//n)+2*pad
# ne = 2048+2*pad
# ne = 3096+512+2*pad
show = False

rho = 0.3#float(sys.argv[1])#0.3
...
pars = {'niter': 1025, 'err_step': 4, 'vis_step': 16}
