...
#     qsub -v CONFIG=config_steps15_c0.conf,SCRIPT=steps15.py polaris_run_noshrink_c0.sh
#     qsub -v CONFIG=config_step6_bin2_noshrink_c0.conf polaris_run_noshrink_c0.sh  # iters   0- 512
#     qsub -v CONFIG=config_step6_bin1_noshrink_c0.conf polaris_run_noshrink_c0.sh  # iters 512- 768
#     qsub -v CONFIG=config_step6_bin0_noshrink_c0.conf polaris_run_noshrink_c0.sh  # iters 768-1024
#
...
CONFIG=${CONFIG:-config_step6_bin2_noshrink_c0.conf}
