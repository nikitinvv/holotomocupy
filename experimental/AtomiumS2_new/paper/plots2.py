...
_fy, _fx = _tmp.shape
_y0, _y1 = _fy//2 - ny//2, _fy//2 + ny//2
_x0, _x1 = _fx//2 - nx//2, _fx//2 + nx//2
_z0, _z1 = crop, nz+crop
print(_z0,_z1)
_sel = _files[_z0:_z1]
...
mshow2(aa, vmax=0.95, vmin=-0.05); plt.savefig("figs/precz.png",     dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
mshow2(bb, vmax=0.95, vmin=-0.05); plt.savefig("figs/mrecz.png",     dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
...
mshow2(aa, vmax=0.95, vmin=-0.05); plt.savefig("figs/precy.png",     dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
mshow2(bb, vmax=0.95, vmin=-0.05); plt.savefig("figs/mrecy.png",     dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
...
mshow1_line(aa_c, p0, p1, color='limegreen', vmax=0.95, vmin=-0.05); plt.savefig("figs/preczz.png",  dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
mshow1_line(bb_c, p0, p1, color='red', vmax=0.95, vmin=-0.05); plt.savefig("figs/mreczz.png",  dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
...
aa_c = aa_full[y0c:y1c, x0c:x1c]
bb_c = bb_full[y0c:y1c, x0c:x1c]
mshow1_line(aa_c, p0, p1, color='limegreen', vmax=0.95, vmin=-0.05); plt.savefig("figs/preczz2.png", dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
mshow1_line(bb_c, p0, p1, color='red', vmax=0.95, vmin=-0.05); plt.savefig("figs/mreczz2.png", dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
save_profile(aa_slab[:, y0c:y1c, x0c:x1c], bb_slab[:, y0c:y1c, x0c:x1c],
...
x0c, x1c = nx//2-s+stx, nx//2+s+stx
aa_c = aa_full[z0c:z1c, x0c:x1c]
bb_c = bb_full[z0c:z1c, x0c:x1c]
mshow1_line(aa_c, p0, p1, color='limegreen', vmax=0.95, vmin=-0.05); plt.savefig("figs/precyy.png",  dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
mshow1_line(bb_c, p0, p1, color='red', vmax=0.95, vmin=-0.05); plt.savefig("figs/mrecyy.png",  dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
save_profile(aa_slab[z0c:z1c, :, x0c:x1c], bb_slab[z0c:z1c, :, x0c:x1c],
...
aa_c = aa_full[z0c:z1c, x0c:x1c]
bb_c = bb_full[z0c:z1c, x0c:x1c]
mshow1_line(aa_c, p0, p1, color='limegreen', vmax=0.95, vmin=-0.05); plt.savefig("figs/precyy3.png", dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
mshow1_line(bb_c, p0, p1, color='red', vmax=0.95, vmin=-0.05); plt.savefig("figs/mrecyy3.png", dpi=300, bbox_inches="tight", pad_inches=0.02); plt.close()
save_profile(aa_slab[z0c:z1c, :, x0c:x1c], bb_slab[z0c:z1c, :, x0c:x1c],
