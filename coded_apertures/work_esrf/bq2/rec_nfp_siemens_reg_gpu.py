...
path_out = f'/data/vnikitin/ESRF/ID16A/20240924_rec/SiemensLH/SiemensLH_010nm_nfp_reg_new{lam1:1.1e}_{lam2:1.1e}_{n}_{pad}'
...
# 
# $$ H(q,\psi,{{x}})=F(J(q)\cdot S_{{x}}(\psi))+\lambda\|\nabla C(\psi)\|_2^2=\left\||L(M(q,\psi,x))|-d\right\|+\lambda\|\nabla C(\psi)\|_2^2
# $$
...
pars = {'niter': 5000, 'err_step': 64, 'vis_step': 128}
